...
class NetowrkingSpider(scrapy.Spider):
    name = 'netowrking'
    allowed_domains = ['https://www.indiabix.com/networking/questions-and-answers/']
    start_urls = ['https://www.indiabix.com/networking/questions-and-answers/']
