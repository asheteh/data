...
'''
driver = driver = webdriver.Chrome(r"C:\Users\Abhijit.shete\3D Objects\scrapy\chromedriver_win32\chromedriver")
for i in range(100):
	driver.get('https://www.youtube.com/watch?v=6ESS7LJhPIk&t=594s')
	sleep(2)
'''
