...
def Hua_Hai_Aaj_Pehli_Baar_Guitar_Tabs___Lead_‘«Ù_Sanam_Re___Abhijeet(request):
...
def Deewani_Mastani_Guitar_Tabs___Lead_‘«Ù_Bajirao_Mastani___Abhijeet(request):
...
def Shreya_Ghoshal_Guitar_Tabs___Lead_‘«Ù_Best_of_Shreya_Ghoshal___Abhijeet(request):
...
def Easy___Shawn_Mendes__Se__orita_Guitar_Chords_with_Strumming_ft__Camila_Cabello___Abhijeet(request):
...
def Ankit_Tiwari‘«ˆGuitar__Yeh_Tere_Do_Naina_Chords_with_Strumming_Pattern___Abhijeet(request):
...
def Somebody‘«÷s_Guitar_Chords_with_Capo___Strumming_‘«Ù_Enrique_Iglesias___Abhijeet(request):
...
def Guitar__Bairiya_Chords___Bombairiya_·__Arko___Abhijeet(request):
...
def Guitar__Dil_Mein_Ho_Tum_Chords_by_Armaan_Malik_·__Why_Cheat_India___Abhijeet(request):
...
def Bhaiji__Do_Naina_Chords_with_Strumming_Pattern___Yasser_Desai‘«ÙGuitar___Abhijeet(request):
...
def KK__Pehle_Ke_Jaisa_Chords_with_Strumming_Pattern___Jalebi‘«ÙGuitar___Abhijeet(request):
...
def Soch_Na_Sake_Guitar_Chords_with_Strumming_Pattern___Airlift‘«ÙArijit_Singh___Abhijeet(request):
...
def Guitar__Tum_Se_Chords_with_Strumming_Pattern__Capo____Jubin_Nautiyal‘«ˆJalebi___Abhijeet(request):
...
def Aap_Se_Milkar_Chords_with_Strumming_Pattern‘«ˆAyushmann_Khurrana___Guitar___Abhijeet(request):
	text = Sargams.objects.filter(id__iexact =429)
	lists = Sargams.objects.filter(song_names__icontains='t')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/song.html',context)

def Le_Ja_Tu_Kahin_Chords_with_Strumming_Pattern___Arijit_Singh‘«ÙGuitar___Abhijeet(request):
	text = Sargams.objects.filter(id__iexact =430)
	lists = Sargams.objects.filter(song_names__icontains='s')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/song.html',context)

def Aye_Zindagi_Chords_with_Strumming_Pattern___Sonu_Nigam‘«ÙGuitar___Abhijeet(request):
	text = Sargams.objects.filter(id__iexact =431)
	lists = Sargams.objects.filter(song_names__icontains='t')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/song.html',context)

def Arijit__Woh_Ladki_Chords_with_Strumming_Pattern___Andhadhun‘«ˆGuitar___Abhijeet(request):
	text = Sargams.objects.filter(id__iexact =432)
	lists = Sargams.objects.filter(song_names__icontains='c')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/song.html',context)

def Doorie_Chords_with_Strumming_Pattern___Benjamin_Rohan‘«ÙGuitar___Abhijeet(request):
...
def Atif_Aslam__Tum_Chords_with_Strumming_Pattern___Laila_Majnu‘«ÙGuitar___Abhijeet(request):
...
def Nazar_Na_Lag_Jaaye_Chords_with_Strumming_Pattern_‘«Ù_Guitar___Ash_King___Abhijeet(request):
...
def Chori_Chori_Jab_Nazrein_Mili_Chords_With_Strumming_Pattern‘«ˆGuitar___Namita___Abhijeet(request):
...
def Ayushmann_Khurrana___Chan_Kitthan_Chords_With_Strumming___Guitar_·___Abhijeet(request):
